...
public class FlockP2pService extends IWifiP2pManager.Stub {
    ...
    public FlockP2pService(Context context) {
        mContext = context;
...
//                "WifiP2pService");
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case DROP_WIFI_USER_ACCEPT:
                    ...
                    mWifiChannel.sendMessage(FlockP2pService.DISCONNECT_WIFI_REQUEST, 1);
    ...
    private void sendPeersChangedBroadcast() {
        ...
        intent.addFlags(FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT);
        try {
			mContext.sendBroadcastAsUser(intent, (UserHandle) UserHandle.class.getDeclaredField("ALL").get(null));
		} catch (IllegalArgumentException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IllegalAccessException e) {
    ...
    private void sendP2pConnectionChangedBroadcast() {
        ...
        mWifiChannel.sendMessage(FlockP2pService.P2P_CONNECTION_CHANGED,
    ...
    private void notifyInvitationReceived() {
        ...
        // Instead of displaying dialog, just accept the connection
    ...
    private void handleGroupRemoved() {
        ...
        if (mTempoarilyDisconnectedWifi) {
            mWifiChannel.sendMessage(FlockP2pService.DISCONNECT_WIFI_REQUEST, 0);
